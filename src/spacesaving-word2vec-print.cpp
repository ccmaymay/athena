...
void usage(ostream& s, const string& program) {
  s << "Load serialized space-saving word2vec (SGNS) model and print to a \n";
  s << "file.\n";
  s << "\n";
  ...
  s << "  <input-path>\n";
  s << "     Path to input file (serialized space-saving word2vec model).\n";
  s << "  <output-path>\n";
  s << "     Path to output file (text representation of space-saving\n";
  s << "     word2vec model).\n";
  s << "\n";
